    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#myFrm").submit(function () {
                ...
                if (!reg.test(productDiscount)) {
                    $("#productDiscount").parent().next("div").html("折扣输入，请输入0-1的数字").css("color", "red");
                    return false;// 防止表单提交
                } else {
...
<body>
<div class="container">
    <h5 style="font-weight: 900">位置：商品列表 --> 修改商品</h5>
    <br/>
    <form id="myFrm" action="/product.do?type=update" method="post" class="form-horizontal">
        <div class="row">
                    ...
                    <select class="form-control" name="typeId">
                        <c:forEach items="${productTypeList}" var="type">
                            ...
                            <c:if test="${type.typeId==product.typeId}">
                                <c:set var="flag" value="selected"></c:set>
                            </c:if>
                            <option value="${type.typeId}" ${flag}>${type.typeName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="productPrice" type="text" class="form-control" value="${product.productPrice}" name="productPrice"
                           placeholder="请输入商品价格..."
                           required="required" maxlength="12"/>
                </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="productNums" type="text" class="form-control" value="${product.stockNumber}" name="stockNumber"
                           placeholder="请输入商品数量..."
                           required="required" maxlength="12"/>
                </div>
                <div class="col-sm-3"></div>
        ...
        <div class="row">
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input id="productDiscount" type="text" class="form-control" value="${product.discount}" name="discount"
                           placeholder="请输入商品折扣..."
                           required="required" maxlength="12"/>
                </div>
                <div class="col-sm-3"></div>
