...
import com.java.constants.CartConstants;
...
public class JDBCUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            //加载驱动
            Class.forName(CartConstants.DRIVER);
            //获取连接
            con = DriverManager.getConnection(CartConstants.URL, CartConstants.SQL_USER, CartConstants.SQL_PASSWORD);
